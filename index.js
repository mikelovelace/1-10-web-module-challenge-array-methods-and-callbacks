...
const filterData = fifaData.filter((element) => {
...
function getFinals(arr) {
    const finalTeams = arr.filter((element) => {
...
function getYears(arr, getFinalsCB) {
    return getFinalsCB(arr).map((item) => {
        return item.Year
    })
}
...
function getWinnersByYear(arr, getFinalsCB, getYearsCB, getWinnersCB) {
    const finals = getFinalsCB(arr, getFinals)
...
function getAverageGoals(getFinalsCB) {
    const average = getFinalsCB.reduce((acc, item) => {
